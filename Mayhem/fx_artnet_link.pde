...
fx_artnet_link(downsample ds_mode,int ds_size)
{
  //LIST OF LIGHTS IN RELATIOSHIP TO REAL LIGHTS (Maybe convert this with a scale function so we can put just in max height and location in ft?)
   lightlist.add(new fx_artnet_entry((int)map(0,0,lightcount,0,255),0,0,1,2,3));
   lightlist.add(new fx_artnet_entry((int)map(1,0,lightcount,0,255),0,7,8,9,10));
   lightlist.add(new fx_artnet_entry((int)map(2,0,lightcount,0,255),0,14,15,16,17));
   lightlist.add(new fx_artnet_entry((int)map(3,0,lightcount,0,255),0,21,22,23,24));
   lightlist.add(new fx_artnet_entry((int)map(4,0,lightcount,0,255),0,28,29,30,31));
   lightlist.add(new fx_artnet_entry((int)map(5,0,lightcount,0,255),0,35,36,37,38));
   lightlist.add(new fx_artnet_entry((int)map(6,0,lightcount,0,255),0,42,43,44,45));
   lightlist.add(new fx_artnet_entry((int)map(7,0,lightcount,0,255),0,49,50,51,52));
   lightlist.add(new fx_artnet_entry((int)map(8,0,lightcount,0,255),0,56,57,58,59));
   lightlist.add(new fx_artnet_entry((int)map(9,0,lightcount,0,255),0,63,64,65,66));
   lightlist.add(new fx_artnet_entry((int)map(10,0,lightcount,0,255),0,70,71,72,73));
   lightlist.add(new fx_artnet_entry((int)map(11,0,lightcount,0,255),0,77,78,79,80));  
   lightlist.add(new fx_artnet_entry((int)map(12,0,lightcount,0,255),0,84,85,86,87));
   lightlist.add(new fx_artnet_entry((int)map(13,0,lightcount,0,255),0,91,92,93,94));     
   lightlist.add(new fx_artnet_entry((int)map(14,0,lightcount,0,255),0,98,99,100,101));
   lightlist.add(new fx_artnet_entry((int)map(15,0,lightcount,0,255),0,105,106,107,108)); 
...
void puffer_control(int mode)
{
  ...
  dmxData[POOFER_BASE+POOFER_T2] = (byte)16;
  dmxData[POOFER_BASE+POOFER_T3] = (byte)32;
